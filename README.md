...
| **LongClaw** | Cross-platform AI desktop assistant with built-in ClawHub skill marketplace, MCP protocol support, and integration with WeChat, QQ, Feishu. | [Guide](./docs/longclaw.md) |
